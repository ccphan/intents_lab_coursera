...
public class ActivityLoaderActivity extends Activity {
	...
	private void startExplicitActivation() {
		...
		intent.setClass(course.labs.intentslab.ActivityLoaderActivity.this, ExplicitlyLoadedActivity.class);
	...
	private void startImplicitActivation() {
		...
		chooserIntent = Intent.createChooser(intent, "Choose an app to open up webpage...");
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (requestCode == GET_TEXT_REQUEST_CODE && resultCode == RESULT_OK) {
			mUserTextView.setText(data.getStringExtra("course.labs.intentslab.text"));
		}
